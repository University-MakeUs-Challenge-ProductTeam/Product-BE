...
import umc.product.domain.member.adviser.common.CommonAuthAdviser;
...
public class CommonAuthController {
    private final CommonAuthAdviser commonAuthAdviser;
    ...
    @PostMapping("/signup")
    public BaseResponse<MemberIdResponse> signUp(@RequestPart CommonSignUpRequest request,
                                                 @RequestPart("file") MultipartFile file) {
        return BaseResponse.onSuccess(commonAuthAdviser.signUp(file, request));
    }
    ...
    public BaseResponse<MemberLoginResponse> socialLogin(@RequestHeader(value = "accessToken") String accessToken,
        ...
        return BaseResponse.onSuccess(commonAuthAdviser.socialLogin(accessToken, loginType));
    }
    ...
    public BaseResponse<MemberGenerateTokenResponse> regenerateToken(@CurrentMember Member member,
        ...
        return BaseResponse.onSuccess(commonAuthAdviser.regenerateToken(refreshToken, member));
    }
    ...
    public BaseResponse<MemberIdResponse> logout(@CurrentMember Member member) {
        return BaseResponse.onSuccess(commonAuthAdviser.logout(member));
    }
    ...
    public BaseResponse<MemberIdResponse> withdrawal(@CurrentMember Member member) {
        return BaseResponse.onSuccess(commonAuthAdviser.withdrawal(member));
    }
